...
This project is forked from [Wayfarer Planner](https://gitlab.com/NvlblNm/wayfarer), with the following major changes:

- 🔄 Updated domain from `wayfarer.nianticlabs.com` to `opr.ingress.com`
- 🎨 Replaced all Wayfarer naming with OPR
- 📦 Migrated to GitHub repository for better maintenance and collaboration
- ✨ New features and improvements will be added as needed

Thanks to the original author for the excellent work! If you need the original version, please visit the [original project](https://gitlab.com/NvlblNm/wayfarer).

## OPR Planner, an IITC plugin to help you nominate and keep track of your candidates

You can plan where to submit your candidates so they are at least 20m away from existing Portals, if possible don't share the same Level 17 cell as other existing Portals, even track possible edit requests to put things in their proper locations. Something like this: 
...
## List of functions
A new link "OPR" is added in the sidebar, you can click it to open the settings dialog.<br />
<img src="https://github.com/XWind18/ingress-opr-tool/raw/main/assets/dialog.png"></img><br/>
...
You can use an additional plugin for TamperMonkey to automatically manage your data using the nominations tracked in OPR:
...
7. Anything that comes after renaming it to "OPR planner." https://github.com/XWind18/ingress-opr-tool/commits/master
