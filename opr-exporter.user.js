...
function init() {
    ...
    */
    ...
    function getName() {
        return new Promise(function (resolve, reject) {
            if (!nameLoadingTriggered) {
                ...
                const url = 'https://opr.ingress.com/api/v1/vault/properties'
                fetch(url)
                    .then((response) => {
    ...
    function addConfigurationButton() {
        ...
        link.className = 'mat-tooltip-trigger sidebar-link sidebar-oprexporter'
    ...
    function loadPlannerData(newUrl) {
        ...
        return fetch(url, fetchOptions)
            ...
            .then(function (allData) {
                ...
                localStorage['oprexporter-lastupdate'] = new Date().getTime()
